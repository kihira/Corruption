...
public class PageData {
    ...
    public static void registerPageData() {
        ...
        pageMap.put("blockTeleport", new PageData("blockTeleport").setPageContents(0, "page.blockTeleport.0", "page.blockTeleport.0.title").setTabName("page.blockTeleport.0.tab"));
