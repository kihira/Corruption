...
public class GuiButtonTab extends GuiButton{
    ...
    public void drawButton(Minecraft minecraft, int width, int height) {
        if (this.visible) {
            ...
            this.drawCenteredString(minecraft.fontRenderer, StatCollector.translateToLocal(this.displayString), this.xPosition + this.width / 2, this.yPosition + (this.height - 8) / 2, 14737632);
        }
    }
}
